...
export function UserEdit(props) {
    ...
    return (
        ...
        <div className=" user-edit-wrapper">            
            <form className="shadow-lg user-edit-form" onSubmit={onFormSubmit}>
            { error && <span className="text-danger">{error}</span> }
                ...
                <button className="btn btn-success" style={{backgroundColor: '#04003b', borderColor: '#04003b'}}>Save user</button>
            </form>
        </div>
        </>
    )
