...
export function NoteEdit(props) {
    ...
    return (
        ...
        <div className='shadow-lg note-edit-wrapper' style={noteEditWrapper}>
            <form onSubmit={onNoteSave}>
                ...
                <button className="btn btn-primary" style={{backgroundColor: '#04003b', borderColor: '#04003b' }}>Save ToDo</button>
            </form>
        </div>
        </>
    )
